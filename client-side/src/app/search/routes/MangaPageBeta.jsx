...
const MangaPageBeta = ({ path, slug, filters }) => {
    ...
    return (
        <section className="my-10">
            ...
            <section className="lg:pl-3 grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-5 justify-center flex-wrap">
